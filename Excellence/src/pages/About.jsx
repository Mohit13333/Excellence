          ...
          <div className="container mx-auto max-w-screen-xl px-6 md:flex md:justify-between md:items-center">
            <div className="md:w-1/2 text-center md:text-left space-y-6">
              <p className="text-lg text-gray-600">
                Hi, Welcome {user ? userName.userName : `Guest to our website`}
              </p>
              ...
              <div className="text-gray-700 space-y-5">
                <p>
                  ...
                  IT professionals who stay updated with the latest industry
                  trends.
                </p>
                <p>
                  <strong>Customization:</strong> We create tailored solutions
                  specific to your unique business needs and goals.
                </p>
                <p>
                  <strong>Customer-Centric:</strong> We prioritize your
                  satisfaction and provide top-notch support for all IT
                  concerns.
                </p>
                <p>
                ...
                <p>
                  <strong>Reliability:</strong> Count on us to ensure your IT
                  environment is secure and available 24/7.
                </p>
              </div>
